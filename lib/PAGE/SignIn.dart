              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      prefixIcon: const Icon(Icons.email, color: Colors.white70, size: 26),
                      hintText: "Email Address",
                  ...
                  TextFormField(
                    ...
                    style: const TextStyle(color: Colors.white, fontSize: 18),
                    decoration: InputDecoration(
                      prefixIcon: const Icon(Icons.lock, color: Colors.white70, size: 26),
                      hintText: "Password",
                      hintStyle: const TextStyle(color: Colors.grey, fontSize: 18),
                      filled: true,
                      fillColor: Colors.black,
                  ...
                  Align(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(context, createSlideRoute(Forgetpass(), position: 'right'));
                      },
                      child: const Text(
                        "Forgot Password?",
                        style: TextStyle(color: Colors.grey, fontSize: 18),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(context, createSlideRoute(SignUp(), position: 'right'));
                        },
                        child: const Text(
                          "Sign Up",
